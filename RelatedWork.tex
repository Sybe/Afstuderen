...
A symbolic approach for timed automata not based on zones is shown in ~\cite{CHARME01}. This approach uses only discrete values for clocks and saves them in BDDs. This approach is quite sensitive to the maximal values of the clocks. In table \ref{table:diagrams} we compare the different types of diagrams we discussed above.
